<template>
  <q-card style="max-width: 800px; width: 800px; min-height: 400px">
    ...
    <q-toolbar
      ...
      "
    >
      <q-toolbar-title> Update Details </q-toolbar-title>
...
const props = defineProps(["ownerId"]);
...
const getOwnerData = () => {
  ...
  api
    .get(`/api/company/${props.ownerId}/owners/edit`, {
      headers: {
...
const onSubmit = () => {
  ...
  api
    .patch(
      `/api/company/${props.ownerId}/owners/update`,
      {
