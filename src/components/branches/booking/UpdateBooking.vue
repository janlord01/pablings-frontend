<template>
  <q-card style="max-width: 800px; width: 800px">
    ...
    <q-toolbar class="bg-primary text-white">
      <q-toolbar-title> Update Booking </q-toolbar-title>
      ...
      <q-form class="relative full-width" @submit="onSubmit">
        <div class="row">
          <q-input
            ...
            :class="
              $q.screen.gt.sm ? 'q-mb-md q-mr-md col' : 'full-width q-mb-sm'
            "
            label=""
            readonly
            filled
          ...
          <q-select
            ...
            :class="$q.screen.gt.sm ? 'q-mb-md col' : 'full-width q-mb-sm'"
        ...
        <div class="row">
          <q-input
            ...
            label="CP Number*"
            :class="
              $q.screen.gt.sm ? 'q-mb-md col q-mr-md' : 'full-width q-mb-sm'
            "
...
const newToken = ref(LocalStorage.get);
...
const getDataBooking = async () => {
  await api
    .get("/api/booking/" + props.bookingId + "/edit", {
      headers: {
    ...
    .then((response) => {
      ...
      formData.guest = response.data.data.guest_name;
    })
    .catch((error) => {
      console.log(error);
    });
