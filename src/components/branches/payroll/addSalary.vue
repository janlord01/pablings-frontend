<template>
  <q-card style="max-width: 500px; width: 500px">
    ...
    <q-toolbar class="bg-primary text-white">
      <q-toolbar-title> Add Salary </q-toolbar-title>
...
const emit = defineEmits(["hideSalaryDialog"]);
...
const onSubmit = () => {
  if (formData.amount === "" || formData.description === "") {
    ...
    payrollStore.addSalaryWorker([formData.amount, formData.description]);
    emit("hideSalaryDialog");
  }
};
const extractStaff = () => {
