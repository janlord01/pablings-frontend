<template>
  <q-card style="max-width: 500px; width: 500px">
    ...
    <q-toolbar class="bg-primary text-white">
      <q-toolbar-title> Add Bonus </q-toolbar-title>
...
const emit = defineEmits(["hideBonusDialog"]);
...
const onSubmit = () => {
  if (formData.amount === "" || formData.description === "") {
    ...
    payrollStore.addBonusWorker([formData.amount, formData.description]);
    emit("hideBonusDialog");
  }
};
const extractStaff = () => {
