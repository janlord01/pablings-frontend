<template>
  <q-card style="max-width: 800px; width: 800px">
    ...
    <q-toolbar
      ...
      "
    >
      <q-toolbar-title> Update Plan </q-toolbar-title>
      ...
      >
        <div class="row q-col-gutter-none relative-position">
          ...
          <div class="col-4">
            <q-select
              filled
              :options="['Free', 'Daily', 'Weekly', 'Monthly', 'Yearly']"
              label="Type*"
...
const getPlanData = async () => {
  ...
  await api
    .get("/api/plans/" + props.planId + "/edit", {
      headers: {
    ...
    .then((response) => {
      ...
      formData.type = response.data.data.days;
